...
const Child_passwordreset = () => {
	...
	// base url
	const url = `http://localhost:5001/reset/child/${param.id}/${param.token}`;
	...
	{/* lottie animation to the left and form element to enter the password on the right */}
      {validUrl ? (
        <div className="container_register">
		  ...
		  {/* when button is clicked, it triggers the handlesubmit button */}
...
export default Child_passwordreset;